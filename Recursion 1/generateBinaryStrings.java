...
public class Main {
    public static void generateBinaryStrings(String asf, int idx) {
        if (idx == asf.length()) {
        ...
        if (asf.charAt(idx) == '?') {
            ...
            asf = asf.substring(0, idx) + "0" + asf.substring(idx + 1);
            generateBinaryStrings(asf, idx + 1);
            asf = asf.substring(0, idx) + "1" + asf.substring(idx + 1);
            generateBinaryStrings(asf, idx + 1);
        } else {
